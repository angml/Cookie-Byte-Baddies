...
VALUES (1, 'Available', 'Pastry', 'Croissant', 2, 3.49, 20),
...
VALUES (1, 'Mandy', 'Manager', '508-555-2345', 'mandymanager@siphappens.com', 120000.00),
       (2, 'Ethan', 'Brown', '978-555-3456', 'ethan.brown@siphappens.com', 105000.00);

INSERT INTO Supplier(ID, Name, Phone, Email)
VALUES (1, 'Sanchez & Sons Sweet Deliveries', '617-555-1234', 'deliveries@sancheznsons.com'),
       (2, 'Baker’s Best', '413-555-4567', 'orders@bakersbest.com');

INSERT INTO SupplyOrder(ID, SupplierID, ManagerID, OrderTotal, OrderQuantity, DateOrdered, DeliveryDate, Delivered)
VALUES (1, 1, 1, 750.50, 20, '2025-03-15 10:00:00', '2025-03-20 10:00:00', TRUE),
       (2, 2, 2, 1250.00, 30, '2025-03-03 10:00:00', '2025-03-09 10:00:00', TRUE);

INSERT INTO Ingredients(IngredientID, IngredientName, Inventory, Expiry, BurnRate, Price)
VALUES (1, 'Espresso Beans', 5, 14, 1, 15.99),
...
VALUES (1, 'Coffee Cups', 0.15, 50, 500),
...
VALUES (4, 'Connor', 'Singh', 'Cashier', 15, 20, 1),
       (2, 'Pearl', 'Thepnakorn', 'Baker', 25, 40, 2);
...
INSERT INTO Costs(CostID, Type, PaymentDate, PaymentAmount, ManagerID)
VALUES (1, 'Labor', '2025-03-24 10:00:00', 1500.00, 1),
       (2, 'Supplies', '2025-03-15 10:00:00', 750.50, 2);
>>>>>>> 5c95dc238766c735c70c0a5714017cdde7288d2b

INSERT INTO Sales(SalesID, Date, TotalSales)
VALUES (1, '2025-04-01 10:00:00', 350.75),
       (2, '2025-03-31 10:00:00', 420.50),
       (3, '2025-03-30 10:00:00', 380.00),
       (4, '2025-03-29 10:00:00', 100.00),
       (5, '2025-03-28 10:00:00', 90.00),
       (6, '2025-03-27 10:00:00', 110.00);
